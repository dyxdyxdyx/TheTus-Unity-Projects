Shader "My Shader/TESS&GS/Phong Tessellation Lighitng" {
    Properties {
        [Header (Lighting)]
    ...
    SubShader {
        ...
        Pass {
            ...
            #include "PhongTessellationLightingPass.hlsl"

            #pragma vertex PhongTessellationLighitngPassVertex
            #pragma hull PhongTessellationLighitngPassHull
            #pragma domain PhongTessellationLighitngPassDomain
            #pragma fragment PhongTessellationLighitngPassFragment
            ENDHLSL
        }
    }
}